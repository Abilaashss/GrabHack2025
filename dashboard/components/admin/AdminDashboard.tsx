...
export default function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  const tabs = [
    ...
    { id: 'analytics', name: 'Analytics', icon: UsersIcon },
    { id: 'models', name: 'Models', icon: CreditCardIcon },
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="border-l border-slate-200 dark:border-slate-700 pl-6">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">
                    AI-Powered Credit Intelligence Management
                  </p>
                </div>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-12 min-h-screen">
        <div className="relative">
          ...
          >
            ...
            {activeTab === 'analytics' && <UserSearch />}
